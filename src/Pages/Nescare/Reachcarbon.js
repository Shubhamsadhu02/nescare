        ...
        <div className="nescare-top pt-5">
            <div className="row">
                <div className="col-lg-6 d-flex flex-column justify-content-center">
                    <div className="nescare-top__section">
                        <div className="nescare-heading">
                            <h1 data-aos="fade-up" data-aos-duration="60" data-aos-easing="linear">To Reduce Carbon, Start With a Calculator</h1>
                        </div>
                        <div className="nescare-paragraph mt-3">
                            <p data-aos="fade-up" data-aos-duration="40" data-aos-easing="linear">Measuring your emissions is step one to reducing them. NESglobal.in free carbon calculator sets you up for sustainability.
                                <br/>
                                <br/>
                ...
                <div className="col-lg-6">
                    <img src='../images/nescare/carbonhome.png' alt='' />
                </div>
            </div>
        </div>
    </div>
...
<section>
        <div className="container">
            <div className="nescare-item mt-15">
                <div className="row">
                    <div className="col-lg-6">
                        <img src='../images/nescare/lower.png' alt='' />
                    </div>
                    <div className="col-lg-6 d-flex flex-column justify-content-center">
            ...
            <div className="nescare-item mt-15">
                <div className="row">
                    ...
                    <div className="col-lg-6 order-md-2 order-1">
                        <img src='../images/nescare/rest.png' alt='' />
                    </div>
                </div>
            </div>
            ...
            <div className="nescare-item mt-15">
                <div className="row">
                    <div className="col-lg-6">
                        <img src='../images/nescare/change.png' alt='' />
                    </div>
                    <div className="col-lg-6 d-flex flex-column justify-content-center">
                        <div className="nescare-container">
                            <div className="nescare-heading">
